...
import com.juliomesquita.cdc.book.application.category.crud.mapper.CategoryMapperRes;
...
@Service
public class CategoryService extends GenericService<Category, CategoryCreateRequest, CategoryUpdateRequest,  CategoryResponse, CategoryRepository, CategoryMapperRes> {
    public CategoryService(final CategoryRepository repository, final CategoryMapperRes mapper) {
