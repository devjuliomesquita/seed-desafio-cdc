...
import com.juliomesquita.cdc.coupon.application.crud.mapper.CouponMapper;
...
@Service
public class CouponService extends GenericService<Coupon, CouponCreateRequest, CouponUpdateRequest, CouponResponse, CouponRepository, CouponMapper> {
    public CouponService(final CouponRepository repository, final CouponMapper mapper) {
